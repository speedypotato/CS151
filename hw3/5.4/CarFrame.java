	...
	public CarFrame(CarModel c) {
		...
		Icon carIcon = new Icon() {
			...
			public void paintIcon(Component c, Graphics g, int x, int y) {
				...
				Rectangle2D.Double carTop = new Rectangle2D.Double
						(cTop, 0, width * TOP_RATIO, height);
				Rectangle2D.Double carBody = new Rectangle2D.Double
						(0, height, width, height);
				Ellipse2D.Double wheel1 = new Ellipse2D.Double
						(w1, height * 2, diameter, diameter);
				Ellipse2D.Double wheel2 = new Ellipse2D.Double
						(w2, height * 2, diameter, diameter);
